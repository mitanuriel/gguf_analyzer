...
<img width="647" height="151" alt="gguf-analyzer info command showing file overview" src="docs/screenshots/info.png" />

### `meta` — metadata table

<img width="659" height="422" alt="gguf-analyzer meta command showing metadata table" src="docs/screenshots/meta.png" />


### `tensors` — tensor inventory

<img width="580" height="282" alt="gguf-analyzer tensors command showing tensor inventory" src="docs/screenshots/tensors.png" />
